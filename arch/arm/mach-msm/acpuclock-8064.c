...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[5] = BW_MBPS(4000), /* At least 500 MHz on bus. */
};
...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	[0]  = { {  128000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  256000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
...
static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {   128000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 0, {   256000, HFPLL, 2, 0x20 }, L2(6),   975000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(6),   975000 },
	{ 0, {   486000, HFPLL, 2, 0x28 }, L2(6),  1000000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   128000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	{ 0, {   256000, HFPLL, 2, 0x20 }, L2(6),   925000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(6),   925000 },
	{ 0, {   486000, HFPLL, 2, 0x28 }, L2(6),   950000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   128000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 0, {   256000, HFPLL, 2, 0x20 }, L2(6),   875000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(6),   875000 },
	{ 0, {   486000, HFPLL, 2, 0x28 }, L2(6),   900000 },
